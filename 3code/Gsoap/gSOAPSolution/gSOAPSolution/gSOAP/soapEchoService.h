...
#include "soapH.h"
    ...
    class SOAP_CMAC EchoService : public soap {
      public:
        ...
        virtual void EchoService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual EchoService *copy() SOAP_PURE_VIRTUAL;
        /// Copy assignment
        EchoService& operator=(const EchoService&);
        ...
        virtual int echo(std::string str, std::string &resault) SOAP_PURE_VIRTUAL;
        /// Web service operation 'login' (returns SOAP_OK or error code)
        virtual int login(std::string account, std::string password, std::string mode, std::string &resault) SOAP_PURE_VIRTUAL;
    };
#endif
