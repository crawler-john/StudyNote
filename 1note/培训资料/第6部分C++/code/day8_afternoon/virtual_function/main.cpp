...
//    person *t_person2 = &t_chinese1;
//    person &t_person3 = t_chineseMan1;
...
//    t_person3.work();
    ...
    person *t_person1 = new chinese("Jim","china",20,"meat","man2");

    t_person1->print();

    delete t_person1;      //t_person1->析构函数
    t_person1 = NULL;
